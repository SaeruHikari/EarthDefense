...
共 **64 张 CSV**：57 张领域表与 7 张战斗表。行数不包含表头。
...
| 结构映射 | [catalog_columns.csv](domain/catalog_columns.csv) | 77 | table, column, type, required |
| 结构映射 | [catalog_tables.csv](domain/catalog_tables.csv) | 45 | table, catalog, parent_table, parent_field, shape, id_column, key_column … |
...
| 战斗 / 敌人与波次 | [combat_enemy_kinds.csv](domain/combat_enemy_kinds.csv) | 7 | id, base_size, bombard_seconds, legacy_speed_multiplier, drone_fire_cooldown, earth_fire_cooldown |
| 战斗 / 敌人与波次 | [combat_fronts.csv](domain/combat_fronts.csv) | 8 | id, ordinal, name, color, direction_x, direction_y, direction_z … |
| 战斗 / 敌人与波次 | [combat_tuning.csv](domain/combat_tuning.csv) | 44 | id, value, minimum, maximum, description |
...
| 科技树 | [deep_technology_nodes_effect_definition.csv](domain/deep_technology_nodes_effect_definition.csv) | 741 | parent_id, position, key, type, value |
...
| 科技树 | [deep_technology_nodes_values.csv](domain/deep_technology_nodes_values.csv) | 321 | parent_id, position, attribute, type, value |
| 经济 / 基础 / 奖励 | [domain_balance.csv](domain/domain_balance.csv) | 58 | key, value, minimum, maximum, unit, description |
...
| 历史与远征兼容 | [expedition_legacy_tech_ids.csv](domain/expedition_legacy_tech_ids.csv) | 6 | parent_id, position, type, value |
...
| 经济 / 基础 / 奖励 | [kill_rewards.csv](domain/kill_rewards.csv) | 7 | kind, minerals, energy, science, score, alien_points, wave_alien_reward … |
| 历史与远征兼容 | [legacy_effect_coefficients.csv](domain/legacy_effect_coefficients.csv) | 63 | key, technology_id, value, source |
...
| 历史与远征兼容 | [legacy_technology.csv](domain/legacy_technology.csv) | 1 | parent_id, position, record_id, has_branches, has_definitions, has_initial_levels |
| 历史与远征兼容 | [legacy_technology_branches.csv](domain/legacy_technology_branches.csv) | 7 | parent_id, position, color, id, name |
| 历史与远征兼容 | [legacy_technology_definitions.csv](domain/legacy_technology_definitions.csv) | 59 | parent_id, position, branch, description, id, legacy_max, max … |
| 历史与远征兼容 | [legacy_technology_definitions_cost.csv](domain/legacy_technology_definitions_cost.csv) | 174 | parent_id, position, currency, type, value |
| 历史与远征兼容 | [legacy_technology_definitions_gates.csv](domain/legacy_technology_definitions_gates.csv) | 46 | parent_id, position, record_id, alien_cost, completed_wave, from_level |
| 历史与远征兼容 | [legacy_technology_definitions_legacy_requires.csv](domain/legacy_technology_definitions_legacy_requires.csv) | 2 | parent_id, position, key, type, value |
| 历史与远征兼容 | [legacy_technology_definitions_preview.csv](domain/legacy_technology_definitions_preview.csv) | 90 | parent_id, position, type, value |
| 历史与远征兼容 | [legacy_technology_definitions_purchase_requires.csv](domain/legacy_technology_definitions_purchase_requires.csv) | 2 | parent_id, position, key, type, value |
| 历史与远征兼容 | [legacy_technology_definitions_requires.csv](domain/legacy_technology_definitions_requires.csv) | 80 | parent_id, position, key, type, value |
| 历史与远征兼容 | [legacy_technology_initial_levels.csv](domain/legacy_technology_initial_levels.csv) | 59 | parent_id, position, key, type, value |
...
| 特性 | [perks.csv](domain/perks.csv) | 1 | parent_id, position, record_id, has_definitions, has_kinds, has_layers, has_legacy_ids … |
...
| 特性 | [perks_kinds.csv](domain/perks_kinds.csv) | 3 | parent_id, position, type, value |
| 特性 | [perks_layers.csv](domain/perks_layers.csv) | 2 | parent_id, position, type, value |
...
| 科技树 | [technology_attribute_schema.csv](domain/technology_attribute_schema.csv) | 87 | attribute, type |

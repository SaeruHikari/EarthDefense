...
public partial class PresentationChecks : Node
{
    ...
    public override async void _Ready()
    {
        try
        {
            ...
            Check(_app.ResearchGraph.Nodes.Count(n => !n.B("is_successor")) == 299, "299 real base research nodes");
            Check(_app.ResearchGraph.Nodes.Count(n => n.S("size") == "small") == 246, "246 small independent nodes");

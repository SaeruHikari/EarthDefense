...
{
    public static readonly string[] CheatResourceIds = ["minerals", "energy", "science", "resource_cores", "alien_points", "alien_chips"];
    private static readonly string[] CheatResourceNames = ["矿物", "能量", "科研", "资源核心", "外星科技点", "外星芯片"];
    private static readonly string[] CheatResourceIcons = ["mineral", "energy", "science", "core", "alien", "chip"];
    ...
    private void CreateCheatControl()
    {
        CheatAmountField = new LineEdit
        {
            ...
            Text = "1000", PlaceholderText = "输入要增加的数量", TooltipText = "增加到当前余额；资源核心、外星科技点和外星芯片必须是正整数。"
        };
    ...
    private void DrawResourceCheats()
    {
        ...
        for (int i = 0; i < CheatResourceIds.Length; i++)
        {
            ...
            Color accent = i is 4 or 5 ? UiTheme.Alien : i is 1 or 3 ? UiTheme.Amber : UiTheme.Mint;
        ...
        Text("每次提交累加到所选资源；外星芯片独立保存在永久特性档案中。", new Vector2(184, 712), 12, UiTheme.Muted);
